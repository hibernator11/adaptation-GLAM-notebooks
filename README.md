...
) to compute the frequency distribution of the words included in the description column. [An adaptation of this notebook](reusing_BNE_thematic.ipynb) is provided to use a [metadata dataset provided by the National Library of Spain](https://datosabiertos.bne.es/catalogo/dataset/recoleccion-de-paginas-web-tematicas1).
